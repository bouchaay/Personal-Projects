...
sl_max_usd = 150  # Stop Loss maximum en USD #4
tp_static = 300  # Take Profit statique en USD #3
sl_move_threshold_usd = 100  # Seuil de déplacement du stop loss en USD (pas de pips)
multiplicateur_lot = 1
...
def backtest_strategy(jour, balance):
    ...
    data["EMA30"] = data["close"].ewm(span=40, adjust=False).mean()
...
if __name__ == "__main__":
    ...
    results = []
    for jour in range(4, 5):  # De 1 jour à 31 jours
